...
function _start()
{
    ...
    var x = setInterval(() => {
        ...
        if(distance <= 0){
            ...
            document.getElementById("canvas").classList.remove("nascosto");
            document.getElementById("headline").innerHTML = "Il countdown è terminato!<br>La tua sorpresa verrà rivelata tra pochi secondi...";
            setTimeout(function() {
                window.location.href = "https://streetparadezurigo.com/";
            }, 8000);
